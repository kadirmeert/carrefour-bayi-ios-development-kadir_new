...
-(id)getDigitalLoanUrl:(NSString*)token bankIca:(NSString *)bankIca loanBankIca:(NSString *)loanBankIca amount:(NSString*)amount orderNo:(NSString*)orderNo campaignCode:(NSString*)campaignCode basketInfo:(NSString *)basketInfo iFrameSignature:(NSString *)iFrameSignature getDigitalLoanUrlCallback:(SEL)callback getDigitalLoanUrlTarget:(id)target;

-(id)openDigitalLoanUrl:(MfsWebView*)webView response:(MfsResponse *)response digitalLoanWebViewCallback:(SEL)digitalLoanWebViewCallback digitalLoanWebViewTarget:(id)digitalLoanWebViewTarget;
...
@property (strong,nonatomic) NSString* resultUrlLoan;

@property (strong,nonatomic) NSString* iFrameSignatureForLoan;
