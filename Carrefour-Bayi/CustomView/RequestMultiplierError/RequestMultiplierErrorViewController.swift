//
//  RequestMultiplierErrorViewController.swift
//  Carrefour-Bayi
//
...
class RequestMultiplierErrorViewController: BaseViewController {

    //    MARK: - Variables
    var viewModel: RequestMultiplierErrorViewModel!
    ...
    private func initUI(){
        ...
        self.multiplierLabel.text = "Katsayı:  \(quantityMultiplier ?? 1)"
    }
...
//    MARK: - RequestMultiplierErrorViewModelDelegate Methods
extension RequestMultiplierErrorViewController: RequestMultiplierErrorViewModelDelegate {
}
...
//    MARK: - Creator
extension RequestMultiplierErrorViewController: XibNameProvider {
    static var xibName: String {
        get {
            return "RequestMultiplierErrorViewController"
        }
    }
    
    class func create(quantityMultiplier: Int) -> RequestMultiplierErrorViewController {
        let vc: RequestMultiplierErrorViewController = RequestMultiplierErrorViewController.instantiateFromNib()
        let viewModel: RequestMultiplierErrorViewModel = RequestMultiplierErrorViewModel()
