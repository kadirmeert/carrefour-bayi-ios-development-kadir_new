...
@IBDesignable class CircularProgressView: UIView {
    ...
    //width of cicular bar
    @IBInspectable public var barLineWidth: CGFloat = 17.0
    ...
    public func start(beginingValue: Int, interval: TimeInterval = 1, elapsedTime: TimeInterval = 0) {
        //Start timer
